...
from megatron.bridge.models.qwen_vl.modeling_qwen35.rope import Qwen35VLMultimodalRotaryEmbedding
from megatron.bridge.models.qwen_vl.modeling_qwen35.transformer_block import Qwen35VLTransformerBlock
from megatron.bridge.models.transformer_config import TransformerConfig


class Qwen35VLGPTModel(GPTModel):
    """Qwen35-VL GPT model with vision-language capabilities."""
    ...
    def __init__(
        ...
        # rebuild rope
        self.rotary_pos_emb = Qwen35VLMultimodalRotaryEmbedding(
        ...
        self.decoder = Qwen35VLTransformerBlock(
            config=self.config,
    ...
    def forward(
        ...
        *,
        ...
        hidden_states = self.decoder(
            ...
            # Qwen35 VL blocks do not currently consume fused cos/sin; pass along
