...
from megatron.bridge.models.qwen_vl.modeling_qwen35.transformer_block import Qwen35VLVisionTransformerBlock
...
from megatron.bridge.models.qwen_vl.modeling_qwen35.utils import (
    Qwen35VLVisionPatchEmbed,
    Qwen35VLVisionPatchMerger,
    Qwen35VLVisionRotaryEmbedding,
)


class Qwen35VLVisionModel(VisionModule):
    """Qwen35 ViT vision model.
    ...
    def __init__(
        self,
        transformer_config: Qwen35VLTransformerConfig,
        ...
        self.patch_embed = Qwen35VLVisionPatchEmbed(transformer_config)
        ...
        # Transformer layers.
        self.decoder = Qwen35VLVisionTransformerBlock(
        ...
        if self.post_process:
            self.merger = Qwen35VLVisionPatchMerger(
                transformer_config,
                patch_merger_spec,
