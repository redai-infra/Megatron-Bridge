...
from megatron.bridge.models.qwen_vl.modeling_qwen35.utils import Qwen35VLVisionPatchMerger


class Qwen35VLVisionTransformerBlock(TransformerBlock):
    """
    Vision Transformer Block for Qwen35VL vision model.
    """
...
class Qwen35VLTransformerBlock(TransformerBlock):
    """
    Transformer Block for Qwen35VL model.
    """
