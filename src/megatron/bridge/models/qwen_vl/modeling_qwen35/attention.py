...
from megatron.bridge.models.qwen_vl.modeling_qwen35.rope import apply_rotary_pos_emb_absolute


class Qwen35VLSelfAttention(SelfAttention):
    """
    Overrides the SelfAttention class, the difference is that qwen35vl uses apply_rotary_pos_emb_absolute
