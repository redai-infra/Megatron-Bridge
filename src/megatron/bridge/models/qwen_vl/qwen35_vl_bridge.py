...
class Qwen35VLMoEBridge(MegatronModelBridge):
    ...
    and Megatron-Core Qwen35VLModel formats, including weight mappings and
    ...
    - Vision model weights (same as Qwen35-VL: deepstack, merger, patch embed)
    ...
    def mapping_registry(self) -> MegatronMappingRegistry:
        ...
        2. Vision model mappings (Qwen35-VL style):
...
class Qwen35VLBridge(MegatronModelBridge):
    ...
    and Megatron-Core Qwen35VLModel formats. Unlike the MoE variant, this model uses
